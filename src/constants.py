...
PIXEL_INFERENCE_DIR_PATH = os.path.join(DATA_DIR_PATH, "Pixel_Inference")
...
PIXEL_DDPM_NAME = "Pixel_DDPM"
PIXEL_DDPM_MODEL_PATH = os.path.join(CHECKPOINT_DIR_PATH, PIXEL_DDPM_NAME)
