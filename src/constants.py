...
DDPM_IMAGE_NAME = "DDPM_Image"
DDPM_IMAGE_MODEL_PATH = os.path.join(CHECKPOINT_DIR_PATH, DDPM_IMAGE_NAME)
DDPM_IMAGE_INFERENCE_DIR_PATH = os.path.join(DATA_DIR_PATH, f"{DDPM_IMAGE_NAME}_Inference")
DDPM_IMAGE_CORRECTION_DIR_PATH = os.path.join(DATA_DIR_PATH, f"{DDPM_IMAGE_NAME}_Correction")

DDPM_PIXEL_NAME = "DDPM_Pixel"
DDPM_PIXEL_MODEL_PATH = os.path.join(CHECKPOINT_DIR_PATH, DDPM_PIXEL_NAME)
DDPM_PIXEL_INFERENCE_DIR_PATH = os.path.join(DATA_DIR_PATH, f"{DDPM_PIXEL_NAME}_Inference")
DDPM_PIXEL_CORRECTION_DIR_PATH = os.path.join(DATA_DIR_PATH, f"{DDPM_PIXEL_NAME}_Correction")
...
RESNET_CORRECTION_DIR_PATH = os.path.join(DATA_DIR_PATH, f"{RESNET_NAME}_Correction")
